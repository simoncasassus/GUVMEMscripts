...
def restore(model_fits="", residual_ms="", restored_image="restored", stokes="I", weighting="robust", robust=2.0):
	ia = image()
	qa = quanta()
	...
	cdelt_string = str(qa.convert(v=cdelt2, outunit="arcsec")["value"]) + "arcsec"
...
psnr, peak, rms = restore(model_fits=model_fits, residual_ms=residual_ms, restored_image=restored, stokes="I", weighting=weighting, robust=robust)
